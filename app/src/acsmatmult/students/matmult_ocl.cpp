...
//   // create buffers, uses in bytes so multiply by size of float
...
//   // copy our data to the device buffers
...
//    //Set local and global work group items
//    const int TS = 1;
...
//   // read results, we place them in matric c.
...
// //Create the program and tell which device it has to compile
// auto program = clCreateProgramWithSource(context, 1, (const char **) &kernel_source, nullptr, &err);
